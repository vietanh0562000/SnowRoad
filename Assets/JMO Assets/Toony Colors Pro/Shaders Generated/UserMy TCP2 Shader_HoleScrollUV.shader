...
Shader "Toony Colors Pro 2/User/My TCP2 Shader_HoleScrollUV"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float4 __albedo = ( TCP2_TEX2D_SAMPLE(_BaseMap, _BaseMap, input.pack0.xy + frac(_Time.yy * _BaseMap_SC.xy)).rgba );
				float __alpha = ( __albedo.a );
