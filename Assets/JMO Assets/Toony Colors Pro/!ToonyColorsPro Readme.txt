...
2.9.15
#### Added
- [Hybrid Shader 2] Added support for "GPU Resident Drawer"
- [Hybrid Shader 2][Shader Generator 2] Added support for "Adaptive Probe Volumes"
#### Modified
- [Shader Generator 2] Renamed "DOTS Instancing" feature to "BRG Instancing" (for 'Batch Renderer Group') as it also enables support for GPU Resident Drawer
- [Shader Generator 2] "Forward+" and "Depth Normals Pass" support is now enabled by default in Unity 6
#### Fixed
- [Shader Generator 2] Fixed "DOTS Instancing" object and world matrices compilation errors
