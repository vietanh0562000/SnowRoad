...
namespace DevTools.Extensions
{
    ...
    public static class Vector2Ext
    {
        ...
        public static Vector2 LeftNormal(this Vector2 v)  { return new Vector2(-v.y, v.x); }
        public static Vector2 RightNormal(this Vector2 v) { return new Vector2(v.y, -v.x); }
        ...
        public static Vector2 ToVector3(this Vector2 v) { return new Vector3(v.x, v.y, 0); }
    }

    public static class Vector3Ext
    {
        public static float AngleSigned(this Vector3 a, Vector3 b, Vector3 normal) { return Mathf.Atan2(Vector3.Dot(normal, Vector3.Cross(a, b)), Vector3.Dot(a, b)) * Mathf.Rad2Deg; }
        ...
        /// <summary>
        /// Return true if v1 and v2 are equal, or different but very close with accuracy.
        /// </summary>
        /// <param name="v1"></param>
        /// <param name="v2"></param>
        /// <param name="accuracy"></param>
        /// <returns></returns>
        public static bool Approximately(this Vector3 v1, Vector3 v2, float accuracy)
        {
            Vector3 v1MinusV2 = v1;
            v1MinusV2.x -= v2.x;
            v1MinusV2.y -= v2.y;
            v1MinusV2.z -= v2.z;
            return Vector3.SqrMagnitude(v1MinusV2) < accuracy;
        }
        
        public static bool Approximately2D(this Vector3 v1, Vector3 v2, float accuracy)
        {
            Vector2 v1MinusV2 = v1;
            v1MinusV2.x -= v2.x;
            v1MinusV2.y -= v2.y;
            return Vector2.SqrMagnitude(v1MinusV2) < accuracy;
        }
    ...
    public static class QuaternionExt
    {
        ...
        /// <param name="q2"></param>
        /// <returns></returns>
        public static bool DifferentOrientation(this Quaternion q1, Quaternion q2) { return Math.Abs((double)Quaternion.Dot(q1, q2)) <= 0.999998986721039; }
    }
    ...
    public static class StringExt
    {
        ...
        public static SpanSplitter SplitEfficient(this string s, char delimiter)
        {
            var span = s.AsSpan();
            return new SpanSplitter(span, delimiter);
        }
        ...
        public readonly ref struct SpanSplitter
        {
            ...
            public SpanSplitter( ReadOnlySpan<char> source, char separator )
            {
                _source    = source;
            ...
            {
                return new SpanSplitEnumerator( _source, _separator );
            }
        }
        ...
        public ref struct SpanSplitEnumerator
        {
            ...
            [MethodImpl( MethodImplOptions.AggressiveInlining )]
            public SpanSplitEnumerator( ReadOnlySpan<char> source, char separator )
            {
                _nextStartIndex = 0;
                _source         = source;
                _separator      = separator;
            ...
            public bool MoveNext()
            {
                ...
                _nextStartIndex += 1 + _current.Length;
            ...
            public readonly ref struct SpanSplitValue
            {
                ...
                public SpanSplitValue(int startIndex, int length, ReadOnlySpan<char> source)
                {
