namespace BasePuzzle
{
   using System;
    ...
    public static class ListExtensions
    {
        ...
        public static int FirstIndexOf<T>(this IEnumerable<T> self, T t)
        {
            var index = 0;
...
#nullable enable
    ...
    public static class ArrayExtensions
    {
        ...
        public static bool ResizeArray<T>(ref T[,] original, int newCoNum, int newRoNum)
        {
            if (original.GetLength(0) == newCoNum && original.GetLength(1) == newRoNum) return false;

            T[,] newArray = new T[newCoNum, newRoNum];
            int  minX     = Math.Min(original.GetLength(0), newCoNum);
            int  minY     = Math.Min(original.GetLength(1), newRoNum);
        ...
        public static bool ResizeArray<T>(ref T[] original, int newCount)
        {
            if (original.Length == newCount) return false;

            Array.Resize(ref original, newCount);
            return true;
        }
    }
