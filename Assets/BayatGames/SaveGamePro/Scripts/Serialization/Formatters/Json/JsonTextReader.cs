    ...
    public class JsonTextReader : JsonReader
    {
        ...
        public override object Read(Type type)
        {
            ...
            else
            {
                ...
                {
                    result = DateTime.FromBinary(Read<long>());
                }
                else if (type == typeof(DateTimeOffset))
                {
                    ...
                    DateTimeOffset dateTimeOffset = new DateTimeOffset(ReadProperty<long>(), new TimeSpan(ReadProperty<long>()));
