...
namespace BayatGames.SaveGamePro.Serialization.Types
{
	...
	public class SaveGameType_Rigidbody2D : SaveGameType
	{
		...
		public override void Write ( object value, ISaveGameWriter writer )
		{
			...
			writer.WriteProperty ( "velocity", rigidbody2D.linearVelocity );
			...
			writer.WriteProperty ( "drag", rigidbody2D.linearDamping );
			writer.WriteProperty ( "angularDrag", rigidbody2D.angularDamping );
			...
			foreach ( string property in reader.Properties )
			{
				switch ( property )
				{
					...
					case "rotation":
						...
						break;
					case "velocity":
						rigidbody2D.linearVelocity = reader.ReadProperty<UnityEngine.Vector2> ();
						break;
					...
					case "inertia":
						...
						break;
					case "drag":
						rigidbody2D.linearDamping = reader.ReadProperty<System.Single> ();
						break;
					case "angularDrag":
						rigidbody2D.angularDamping = reader.ReadProperty<System.Single> ();
						break;
					case "gravityScale":
