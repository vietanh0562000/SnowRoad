...
namespace BayatGames.SaveGamePro.Serialization.Types
{
	...
	public class SaveGameType_Rigidbody : SaveGameType
	{
		...
		public override void Write ( object value, ISaveGameWriter writer )
		{
			...
			writer.WriteProperty ( "velocity", rigidbody.linearVelocity );
			writer.WriteProperty ( "angularVelocity", rigidbody.angularVelocity );
			writer.WriteProperty ( "drag", rigidbody.linearDamping );
			writer.WriteProperty ( "angularDrag", rigidbody.angularDamping );
		...
		public override void ReadInto ( object value, ISaveGameReader reader )
		{
			...
			foreach ( string property in reader.Properties )
			{
				...
				{
					case "velocity":
						rigidbody.linearVelocity = reader.ReadProperty<UnityEngine.Vector3> ();
						break;
					case "angularVelocity":
						rigidbody.angularVelocity = reader.ReadProperty<UnityEngine.Vector3> ();
						break;
					case "drag":
						rigidbody.linearDamping = reader.ReadProperty<System.Single> ();
						break;
					case "angularDrag":
						rigidbody.angularDamping = reader.ReadProperty<System.Single> ();
						break;
					case "mass":
